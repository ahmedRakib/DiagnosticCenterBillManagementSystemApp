...
namespace DiagnosticCenterBillManagementSystemApp
{
    public partial class TestWiseReport : System.Web.UI.Page
    {
        ...
        protected void showButton_Click(object sender, EventArgs e)
        {
            ...
            List<TestDateVM> AllTestDate = aTestDateManager.GetTestWithTestName(fromDateNew, toDateNew);
            testWiseReportGridView.DataSource = AllTestDate;
        ...
        protected void pdfButton_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=Test Wise Result.pdf");
